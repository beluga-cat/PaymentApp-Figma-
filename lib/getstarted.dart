        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              top: 500,
              child: Container(
                child: const Text("INSTANT PAY", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Color.fromARGB(255, 105, 41, 255),), ),
                margin: const EdgeInsets.all(20),
                padding: const EdgeInsets.fromLTRB(10, 20, 10, 20),
                
                decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 105, 41, 255),
            ...
            Positioned(
              ...
              child: InkWell(
                ...
                child: Container(
                  child: const Text("INSTANT PAY", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900,color: Colors.white),),
                  margin: const EdgeInsets.all(20),
                  padding: const EdgeInsets.fromLTRB(10, 20, 10, 20),
              ...
              left: 110,
              child: Container(
                child: const Text("Your Perfect Payment Partner", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w300,color: Colors.white),),
